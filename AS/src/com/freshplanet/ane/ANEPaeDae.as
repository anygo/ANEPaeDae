...
package com.freshplanet.ane
{
	...
	{
		private static var _instance:ANEPaeDae;
		
		private var extCtx:ExtensionContext = null;
				
		public function ANEPaeDae()
		{
			if (!_instance)
			{
				extCtx = ExtensionContext.createExtensionContext("com.freshplanet.ane.ANEPaeDae", null);
				if (extCtx != null)
				{
				...
				{
					trace('[ANEPaeDae] Error - Extension Context is null.');
				}
				_instance = this;
			}
			else
		...
		public static function getInstance() : ANEPaeDae
		{
			return _instance ? _instance : new ANEPaeDae();
		}
